...
**Generated:** 2026-06-16T00:00:19
**Schema:** PMM_SCHEMA=1.1
**Total artifacts graded:** 72
**Overrides applied:** 3
**Scan duration:** 16.49s
...
| `software/spaceship-earth` | 14811 lines, mature codebase | Core paths tested (127 assertions) | Detailed docs (75 lines, examples) | CI/CD with wrangler deploy | Lockfile + lint + CI security audit |
