/**
 * Spoon Indicator — Chromatica Variant (Canonical v2.0.0)
 * Pain tracking and activity modes
...
export const SpoonIndicator: React.FC<SpoonIndicatorProps> = ({ spoonState, onChange }) => {
  const configs = {
    1: { 
      label: 'Gentle Log', 
      desc: 'Pain only. No projects. Voice input preferred.',
      color: SPOON_COLORS.high,
      time: '~5m'
    },
    3: { 
      label: 'Balanced Day', 
      desc: 'Pain + simple projects. Rest timer enabled.',
      color: SPOON_COLORS.medium,
      time: '~15m'
    },
    6: { 
      label: 'Full Management', 
      desc: 'All features. Complex projects. Export reports.',
