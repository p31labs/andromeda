export const setupSovereignPWA = (setStatus: (s: string) => void) => {
  ...
  const manifest = {
    ...
    background_color: "#000000", theme_color: "#39FF14",
    icons: [{
      src: "data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'%3E%3Cpolygon points='50,5 95,25 95,75 50,95 5,75 5,25' fill='none' stroke='%2339FF14' stroke-width='5'/%3E%3C/svg%3E",
