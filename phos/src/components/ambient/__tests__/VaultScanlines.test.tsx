...
import VaultScanlines from '../VaultScanlines';

describe('VaultScanlines', () => {
  it('should render a canvas element', () => {
    render(
      <AtmosphereProvider initialSpoons={3} initialSurface="VAULT">
        <VaultScanlines />
      </AtmosphereProvider>
    );
  ...
  it('should render at crisis spoon level', () => {
    render(
      <AtmosphereProvider initialSpoons={0} initialSurface="VAULT">
        <VaultScanlines />
      </AtmosphereProvider>
    );
    expect(document.querySelector('canvas')).toBeTruthy();
  ...
  it('should render at max spoon level', () => {
    render(
      <AtmosphereProvider initialSpoons={5} initialSurface="VAULT">
        <VaultScanlines />
      </AtmosphereProvider>
    );
    expect(document.querySelector('canvas')).toBeTruthy();
