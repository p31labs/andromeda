...
describe('PixelGrid', () => {
  it('should render a canvas element', () => {
    render(
      <AtmosphereProvider initialSpoons={3} initialSurface="LEDGER">
        <PixelGrid />
      </AtmosphereProvider>
    );
  ...
  it('should render at crisis spoon level', () => {
    render(
      <AtmosphereProvider initialSpoons={0} initialSurface="LEDGER">
        <PixelGrid />
      </AtmosphereProvider>
    );
    expect(document.querySelector('canvas')).toBeTruthy();
  ...
  it('should render at max spoon level', () => {
    render(
      <AtmosphereProvider initialSpoons={5} initialSurface="LEDGER">
        <PixelGrid />
      </AtmosphereProvider>
    );
    expect(document.querySelector('canvas')).toBeTruthy();
