# P31 Labs — SOCIAL DROP (LIVE)
## Deploy-Ready Content — March 26, 2026
### All facts verified. All copy present-tense. Copy-paste and fire.

---

## CORRECTED FACTS (vs. original package)

| Field | OLD (stale) | NOW (correct) |
|-------|-------------|---------------|
| BONDING status | "ships Monday" / future tense | **SHIPPED March 10. LIVE at bonding.p31ca.org** |
| Test count | 440+ | **558 tests green** |
| Spaceship Earth | "live today" (from prior date) | **Live since March** |
| Housing | not mentioned | **9 days to eviction (April 4)** |
| Discovery | in prep | **Filed today (March 26)** |
| Psych eval | ordered | **Completed March 24** |
| CI status | unclear | **558 tests, PR #1 merged, CF Pages verified** |

---

## WAVE 1: KO-FI (Post immediately)
...
## WAVE 4: REDDIT (r/opensource or r/reactjs or r/webdev)
...
## WAVE 5: FESTIVAL FAMILY / PERSONAL NETWORK (Facebook/DMs)
...
## WAVE 6: SUPERSTONK (use existing docs/superstonk_post.md)

**No changes needed to the DD post itself** — the electrical engineering thesis is evergreen. Just verify the Ko-fi link is in the GitHub README (not in the post) per the strategy doc.

Pre-flight:
- [ ] Ko-fi link in GitHub README ✅
...
- [x] No children's full names anywhere (Bashium/Willium are coded)
- [x] No case number in social posts
- [x] No judge names in social posts
- [x] No privileged legal strategy disclosed
- [x] Ko-fi framed as support, not as legal fundraising
- [x] All financial figures match court-filed documents
- [x] S.J. and W.J. initials NOT used in public posts (only coded game names)
