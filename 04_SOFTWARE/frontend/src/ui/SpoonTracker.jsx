 ...
 *
 * Displays:
 * - Current spoon count with visual deduction from baseline
 * - Progressive disclosure layer label (BREATHE/FOCUS/BUILD/COMMAND)
 * - Voltage Inspector: breakdown of the most recently ingested node
 *
 * Props:
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.section}>
        <div style={styles.sectionTitle}>COGNITIVE CAPACITY</div>
        <div style={styles.spoonRow}>
          <span style={{ ...styles.spoonNumber, color: layer.color }}>
            {spoons.toFixed(1)}
          </span>
        ...
        <div style={styles.barOuter}>
          <div style={{ ...styles.barInner, width: `${pct}%`, background: layer.color }} />
        </div>
        <div style={{ ...styles.layerBadge, color: layer.color, borderColor: layer.color + '40' }}>
          {layer.label}
        </div>
      </div>
...
// ── Inline styles (Phosphorus aesthetic) ──
