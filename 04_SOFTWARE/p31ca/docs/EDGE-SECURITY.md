...
- Endpoints called same-origin from `p31ca.org` pages; CORS is not needed
...
- Not authenticated — P2 item: add Bearer token + CF Access rule or Worker-level auth
- See `docs/EGG-HUNT.md` for the `ORCH-WORKER` entry
