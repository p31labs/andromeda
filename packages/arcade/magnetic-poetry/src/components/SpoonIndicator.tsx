/**
 * Spoon Indicator — Magnetic Poetry Variant (Canonical v2.0.0)
...
export const SpoonIndicator: React.FC<SpoonIndicatorProps> = ({ spoonState, onChange }) => {
  const configs = {
    1: { 
      label: 'Simple', 
      desc: '6 words, touch only', 
      color: SPOON_COLORS.high,
      time: '~5m'
    },
    3: { 
      label: 'Balanced', 
      desc: '12 words, synonym matching', 
      color: SPOON_COLORS.medium,
      time: '~15m'
    },
    6: { 
      label: 'Full Canvas', 
      desc: '24 words, full vectors', 
    ...
    <div style={styles.container}>
      <div style={styles.header}>
        ...
        <span style={{ ...styles.badge, background: config.color }}>
          {/* Canonical Unicode indicator, not emoji */}
          ...
          <button
            ...
            style={{
              ...
              ...(spoonState === n ? { 
                ...
                background: `${configs[n as 1 | 3 | 6].color}40`, // 25% opacity
              } : {}),
            }}
          >
            <span style={{
