/**
 * Spoon Indicator — Culinary Matria Variant (Canonical v2.0.0)
 * Recipe browsing and cooking modes
...
export const SpoonIndicator: React.FC<SpoonIndicatorProps> = ({ spoonState, onChange }) => {
  const configs = {
    1: { 
      label: 'Quick Browse', 
      desc: 'Favorites only. Large cards. One-tap cooking.',
      color: SPOON_COLORS.high,
      time: '~5m'
    },
    3: { 
      label: 'Recipe Mode', 
      desc: 'Full catalog. Step-by-step view. Voice guidance.',
      color: SPOON_COLORS.medium,
      time: '~15m'
    },
    6: { 
      label: 'Kitchen Master', 
      desc: 'Inventory sync. Meal planning. Shopping lists.',
