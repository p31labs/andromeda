/**
 * Spoon Indicator — Maid Manager Variant (Canonical v2.0.0)
 * Solo operator pacing modes
...
export const SpoonIndicator: React.FC<SpoonIndicatorProps> = ({ spoonState, onChange }) => {
  const configs = {
    1: { 
      label: 'Gentle Pace', 
      desc: 'One client. Extended rest periods. No rush.',
      color: SPOON_COLORS.high,
      time: '~5m'
    },
    3: { 
      label: 'Steady Work', 
      desc: '2-3 clients. Standard pacing alerts.',
      color: SPOON_COLORS.medium,
      time: '~15m'
    },
    6: { 
      label: 'Full Day', 
      desc: '4+ clients. Aggressive joint protection.',
