/**
 * Spoon Indicator — Cheomatica Variant (Canonical v2.0.0)
 * Color formulation modes for Christyn
...
export const SpoonIndicator: React.FC<SpoonIndicatorProps> = ({ spoonState, onChange }) => {
  const configs = {
    1: { 
      label: 'Quick Mix', 
      desc: 'Recent formulas only. One-tap repeat. No notes.',
      color: SPOON_COLORS.high,
      time: '~5m'
    },
    3: { 
      label: 'Standard Client', 
      desc: 'Full history. Voice notes. Standard workflow.',
      color: SPOON_COLORS.medium,
      time: '~15m'
    },
    6: { 
      label: 'Complex Formulation', 
      desc: 'Custom blends. Full notes. Before/after photos.',
