 ...
 * - Added transaction IDs for ACK correlation
 * - Added error codes in NACK responses
 * - Added version query command
...
#define CMD_VERSION_QUERY   0x40
#define CMD_VERSION_REPORT  0x41
#define CMD_STATS_QUERY     0x42
#define CMD_STATS_REPORT    0x43
#define CMD_ACK             0xA0
...
#define ERR_UNKNOWN_CMD     0x01    // Unknown command byte
#define ERR_INVALID_PARAM   0x02    // Invalid parameter value
#define ERR_CRC_FAIL        0x03    // CRC verification failed
#define ERR_BUFFER_OVERFLOW 0x04    // RX buffer overflow
#define ERR_HAPTIC_FAIL     0x05    // Haptic driver not ready
#define ERR_INVALID_LENGTH  0x06    // Invalid payload length
...
// Valid waveform ID range
#define MIN_WAVEFORM_ID     1
#define MAX_WAVEFORM_ID     123
...
#define BREATH_PHASE_IDLE   0
#define BREATH_PHASE_INHALE 1
#define BREATH_PHASE_HOLD   2
#define BREATH_PHASE_EXHALE 3
